...
//จบไฟล์ Upload เอกสาร		
  ...
  $insertSQL = sprintf("INSERT INTO shipment (transaction_date, product_payment_id, product_id, customer_id, customer_destination, product_dateout, drivermember_id, product_amount, rate_pricein_type1, rate_priceout_type1, rate_pricein_type2, rate_priceout_type2, rate_pricein_type3, rate_priceout_type3, comment, status, pictureorder, ref_product_payment_id, comment2, po_number, order_number, date3, comment3, customer_destination2, product_amount2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['product_amount'], "float"),
                       GetSQLValueString($_POST['rate_pricein_type1'], "float"),
                       GetSQLValueString($_POST['rate_priceout_type1'], "float"),
                       GetSQLValueString($_POST['rate_pricein_type2'], "float"),
                       GetSQLValueString($_POST['rate_priceout_type2'], "float"),
                       GetSQLValueString($_POST['rate_pricein_type3'], "float"),
                       GetSQLValueString($_POST['rate_priceout_type3'], "float"),
					   ...
					   GetSQLValueString($_POST['product_amount2'], "text"));
...
?>
          ...
          <td width="25%" bgcolor="#CCFFFF" class="small">เลขที่ตั๋ว</td>
          <td width="25%" bgcolor="#CCFFFF"><span class="small">
            <input name="ref_product_payment_id" type="text" id="ref_product_payment_id" required placeholder="เลขที่ตั๋ว"/>
          </span></td>
        </tr>
        <tr valign="baseline">
          <td width="25%" align="right" nowrap bgcolor="#FFCCFF"><span class="small">ชื่อย่อปลายทาง :</span></td>
          <td width="25%" bgcolor="#FFCCFF"><span class="small">
            <input name="customer_destination2" type="text" id="customer_destination2" />
          </span></td>
          <td bgcolor="#CCFFFF" class="small">เลขขที่ใบ PO</td>
          <td width="25%" bgcolor="#CCFFFF"><span class="small">
            <input name="po_number" type="text" id="po_number" required placeholder="เลขขที่ใบ PO"/>
          </span></td>
        </tr>
        <tr valign="baseline">
          <td width="25%" rowspan="7" align="right" valign="top" nowrap bgcolor="#FFCCFF"><span class="small">สถานที่จัดส่ง:</span></td>
          <td width="25%" rowspan="7" valign="top" bgcolor="#FFCCFF"><span class="small">
            <textarea name="customer_destination" cols="32" rows="5"></textarea>
          </span></td>
          <td bgcolor="#CCFFFF" class="small">เลขที่ใบสั่งซื้อ</td>
          <td width="25%" bgcolor="#CCFFFF"><span class="small">
            <input name="order_number" type="text" id="order_number" required placeholder="เลขที่ใบสั่งซื้อ"/>
          </span></td>
        </tr>
        <tr valign="baseline">
...
?>
        ...
        <tr valign="baseline">
          <td width="25%" bgcolor="#CCFFFF" class="small">กำหนดวันส่งสินค้าปลายทาง</td>
        ...
        <tr valign="baseline">
          ...
          <td width="25%" bgcolor="#CCFFFF"><select name="driver_id" class="small" id="driver_id">
            <?php
do {  
?>
...
?>
        ...
        <tr valign="baseline">
          <td width="25%" bgcolor="#CCFFFF" class="small">ปริมาณสินค้า (ถุง) :</td>
          <td width="25%" bgcolor="#CCFFFF"><span class="small">
            ...
            <tr>
             ...
             &nbsp;บาท</span></td>
              ...
              <td width="31%" rowspan="2" align="center" valign="top" bgcolor="#FFCC66" class="small"><span class="small">
                <textarea name="comment2" cols="40" rows="5" id="comment2">ไม่มีข้อมูลเพิ่มเติม</textarea>
              </span></td>
              </tr>
            <tr>
