...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE shipment SET type_product=%s, productsource=%s, car_id=%s, car_type=%s WHERE id=%s",
...
<br />  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td>
        ...
        <input type="hidden" name="type_product" value="<?php echo $row_search_product['product_name']; ?>">
        <input type="hidden" name="productsource" value="<?php echo $row_search_product['product_source_code']; ?>">    
