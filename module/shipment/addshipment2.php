...
$query_update_shipment = "SELECT * FROM shipment WHERE status = 99 AND product_payment_id LIKE ".$_GET["product_payment_id"];
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE shipment SET customer_name=%s, car_id=%s, car_type=%s, status=%s WHERE id=%s",
