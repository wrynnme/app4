        ...
        <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="center" valign="top" bgcolor="#FFFFCC">
                    <table align="center">
                        <tr valign="baseline">
                            <td width="25%" align="right" nowrap bgcolor="#FFCCFF"><span
                                    class="small">เลขที่ใบจ่ายสินค้า:</span></td>
                            <td width="25%" bgcolor="#FFCCFF"><span class="small">
                                    <input name="product_payment_id" type="text" value="<?php echo $jobnumber; ?>"
                                        size="32" readonly>
                                </span></td>
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">วันที่ทำรายการ :</span></td>
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">
                                    <input name="transaction_date" type="text" id="date_1" required="required"
                                        placeholder="click" />
                                </span></td>
                        </tr>
                        <tr valign="baseline">
                            <td width="25%" align="right" nowrap bgcolor="#FFCCFF"><span
                                    class="small">ชื่อลูกค้า:</span></td>
                            <td width="25%" bgcolor="#FFCCFF"><span class="small">
                                    <select name="customer_id" id="customer_id" class="selectpicker"
                                        data-live-search="true">
                                        <?php
                    do {
                    ?>
                                        <option value="<?php echo $row_list_customer['id'] ?>">
                                            <?php echo $row_list_customer['name'] ?></option>
                                        <?php
                    ...
                    ?>
                            ...
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">
                                    <input name="ref_product_payment_id" type="text" id="ref_product_payment_id"
                                        required placeholder="ข้อมูลเลขที่ตั๋ว" />
                                </span></td>
                        </tr>
                        <tr valign="baseline">
                            <td width="25%" rowspan="4" align="right" valign="top" nowrap bgcolor="#FFCCFF"><span
                                    class="small">หมายเลขโทรศัพท์ติดต่อ:</span></td>
                        ...
                        <tr valign="baseline">
                            ...
                            <td width="25%" valign="top" bgcolor="#CCFFFF"><span class="small"><input
                                        name="productsource" type="text" id="productsource"> </span></td>
                        </tr>
                        <tr valign="baseline">
                            <td width="25%" align="right" valign="top" nowrap bgcolor="#FFCCFF"><span
                                    class="small">&nbsp;ชื่่อย่อสถานที่ปลายทาง :</span></td>
                            <td width="25%" valign="top" bgcolor="#FFCCFF"><span class="small">
                                    <input name="customer_destination2" type="text" id="customer_destination2" value=""
                                        size="32">
                                </span></td>
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">วันที่ให้ไปรับสินค้าต้นทาง:</span>
                            </td>
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">
                                    <input name="product_dateout" type="text" id="date_2" required="required"
                                        placeholder="click" />
                                </span></td>
                        </tr>
                        <tr valign="baseline">
                            <td width="25%" rowspan="3" align="right" valign="top" nowrap bgcolor="#FFCCFF"
                                class="small">หมายเหตุเพิ่มเติม&nbsp;:</td>
                            ...
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">วันกำหนดส่งสินค้าถึงปลายทาง:</span>
                            </td>
                            <td bgcolor="#CCFFFF"><span class="small">
                                    <input name="date3" type="text" id="date_3" required="required"
                                        placeholder="click" />
                                </span></td>
                        </tr>
                        <tr valign="baseline">
                            <td width="25%" bgcolor="#CCFFFF"><span class="small">ชื่อผู้ขับรถไปรับสินค้าต้นทาง:</span>
                            </td>
                            <td width="25%" bgcolor="#CCFFFF"><select name="driver_id" id="driver_id"
                                    class="selectpicker" data-live-search="true">
                                    <?php
                  do {
                  ?>
                                    <option value="<?php echo $row_list_drivermember['driver_id'] ?>">
                                        <?php echo $row_list_drivermember['driver_first_name'] . "  " . $row_list_drivermember['driver_last_name'] ?>
                                    </option>
                                    <?php
                  ...
                  ?>
                            ...
                            <td colspan="4" align="center" valign="top" nowrap>
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="right" bgcolor="#FFCC00">&nbsp;</td>
                                        <td colspan="3" align="center" bgcolor="#FFCC66" class="small">
                                            กรณีจ้างเหมาเพิ่มเติม<br>
                                            (ย้ายจุด / เกินระยะทาง) กรุณระบุ</td>
                                    </tr>
                                    <tr>
                                        <td width="23%" align="right" valign="bottom" bgcolor="#FFCC00"><span
                                                class="small">ราคาตกลงขายให้ลูกค้าประเภท 1 :

                                            </span></td>
                                        <td width="14%" align="right" valign="bottom" bgcolor="#FFCC00"><span
                                                class="small">
                                                <input type="text" name="rate_pricein_type1" value="" size="10">
                                                &nbsp;บาท</span></td>
                                        <td width="4%" align="right" bgcolor="#FFCC00">&nbsp;</td>
                                        <td width="15%" valign="bottom" bgcolor="#FFCC66"><span
                                                class="small">ราคาตกลงกับลูกค้า</span></td>
                                        <td width="13%" align="right" valign="bottom" bgcolor="#FFCC66" class="small">
                                            <input type="text" name="rate_pricein_type3" value="" size="10">
                                            บาท</td>
                                        <td width="31%" rowspan="2" align="center" valign="top" bgcolor="#FFCC66"
                                            class="small"><span class="small">
                                                <textarea name="comment2" cols="40" rows="5" id="comment2"></textarea>
                                            </span></td>
                                    </tr>
                                    <tr>
                                        <td width="23%" align="right" valign="bottom" bgcolor="#FFCC00"><span
                                                class="small">ราคาจ้างผู้ขับรถส่งสินค้าประเภท 1 :</span></td>
                                        <td width="14%" align="right" valign="bottom" bgcolor="#FFCC00"><span
                                                class="small">
                                        ...
                                        <td width="4%" align="right" bgcolor="#FFCC00">&nbsp;</td>
                                        <td width="15%" valign="bottom" bgcolor="#FFCC66"><span
                                                class="small">ราคาจ้างกับผู้ส่งสินค้า</span></td>
                                        <td width="13%" align="right" valign="bottom" bgcolor="#FFCC66"><span
                                                class="small">
                        ...
                        <tr valign="baseline">
                            ...
                            <td width="25%" align="right" nowrap bgcolor="#CCCCFF"><span
                                    class="small">อัพโหลดเอกสารใบสั่งของจากลูกค้า</span></td>
                            <td width="25%" bgcolor="#CCCCFF"><input name="fileupload" type="file" id="fileupload"
                        ...
                        <tr valign="baseline">
                            <td colspan="4" align="center" valign="middle" nowrap bgcolor="#FFFFCC"><span class="small">
                                ...
                                <input name="status" type="hidden" id="status" value="99"> <input type="submit"
                                    value="บันทึกข้อมูล"> </td>
                        </tr>
                    </table>
                </td>
            </tr>
