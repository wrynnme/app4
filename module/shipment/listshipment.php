		...
		if ($row_listshipment['status'] <> 9){
			...
			echo "
					...
					<td width=5% align=center bgcolor=#FFFFFF>";
						if (($row_listshipment['drivermember_id'] == 0) and ($row_listshipment['picturestatus1'] == "")) {echo "<font color=#AA0000>ยังไม่พิมพ์ใบส่งสินค้า</font>";}
						if (($row_listshipment['drivermember_id'] == 0) and ($row_listshipment['picturestatus1'] <> "")) {echo "<font color=#000066>พิมพ์ใบส่งสินค้าแล้ว</font>";}
			echo "
					</td>
				  	</tr>			
			";
...
<tr>
        <td colspan="12" align="center" bgcolor="#FFFFFF"><table width="20%" border="0" cellspacing="0" cellpadding="0">
            <tr>
