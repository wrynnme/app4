...
$query_listbilling = "SELECT * FROM shipment WHERE status = 1 ORDER BY id DESC";
...
<body>
  ...
  <tr>
    <td align="center" bgcolor="#FFFFCC"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="7" align="center" bgcolor="#FFFF66" class="h3">จัดการเอกสารใบตั้งเบิก</td>
      </tr>
      <tr>
        <td width="14%" align="center" bgcolor="#66FFFF" class="small">วันที่</td>
        <td width="18%" align="center" bgcolor="#66FFFF" class="small">เลขที่ตั๋วสินค้า</td>
        <td width="16%" align="center" bgcolor="#66FFFF" class="small">ผู้ซื้อ</td>
        <td width="16%" align="center" bgcolor="#66FFFF" class="small">ปลายทางส่งสินค้า</td>
        <td width="16%" align="center" bgcolor="#66FFFF" class="small">วันที่สินค้า<br>
        ถึงปลายทาง</td>
        <td width="13%" align="center" bgcolor="#66FFFF" class="small">จำนวน<br>
        (ตัน)</td>
        <td width="7%" align="center" bgcolor="#66FFFF" class="small">พิมพ์ใบตั้งเบิก</td>
        </tr>
        <?php 
			$count_numner = 0;			
		?>
        ...
        <tr>
          ...
          <td width="13%" align="center" bgcolor="#FFFFFF" class="small"><?php echo $row_listbilling['product_amount']; ?></td>
            <td width="7%" align="center" bgcolor="#FFFFFF" class="small"><a target="new" href="module/shipment/status1.php?id=<?php echo $row_listbilling['id']; ?>&product_payment_id=<?php echo $row_listbilling['product_payment_id']; ?>">พิมพ์</a></td>

<!--            <td width="7%" align="center" bgcolor="#FFFFFF" class="small"><a target="new" href="module/pdf/printbilling.php?id=<?php //echo $row_listbilling['id']; ?>">พิมพ์</a></td> -->
        </tr>
